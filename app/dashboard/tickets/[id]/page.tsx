      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              <p className="text-xs text-gray-400 mb-1">Guest status</p>
            ...
            <div>
              <p className="text-xs text-gray-400 mb-1">Order ref</p>
        ...
        {/* Internal notes */}
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <h2 className="font-semibold text-gray-900 mb-1">Internal Notes</h2>
          <p className="text-xs text-gray-400 mb-3">Visible to team only — not shared with the guest.</p>
          <textarea
            rows={3}
