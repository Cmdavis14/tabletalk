...
export default function QRClient({ restaurantName, guestUrl }: Props) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Screen-only header */}
      <header className="bg-[#07111F] print:hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 print:hidden">
        <div className="mb-6">
          <h1 className="text-lg font-semibold text-slate-900">QR Code — Table Card</h1>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 flex flex-col items-center text-center max-w-sm mx-auto shadow-sm">
          ...
          <p className="text-[11px] text-slate-400 break-all font-mono mb-5">{guestUrl}</p>
